 ...
 */
    ...
    public:
        ...
        */
         ...
         */
        portID createPort(blockID block, bool isInput, const std::string &name = "", int width = -1,
        ...
        */
         ...
         * @return True if successful, and false otherwise.
         */
        bool writeBlif(std::ostream &of, int indent = 0);
    ...
    private:
        ...
        * @param id The channel id.
        */
        void writeCircuitName(std::ostream &s, int indent = 0);

        void writeCircuitInputs(std::ostream &s, int indent = 0);

        void writeCircuitOutputs(std::ostream &s, int indent = 0);

        void writeSubckt(std::ostream &s, bbID id, int indent = 0);

        void writeNodeType(std::ostream &s, BlockType t, int indent = 0);

        bool skipNode(BlockType t);

        void writeNodeInOutPorts(std::ostream &s, bbID id, int indent = 0);
